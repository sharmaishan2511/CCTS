...
<body class="custom-background">
    ...
    <h2 class="container text-center my-3">Case Status : Search by Party Name</h2>
    ...
    <div class="services-links my-3">
            <ul>
                ...
                <li><a href="/partyname_search.php" class="btn btn-primary active"><em class="fa fa-file"></em> Party Name</a></li>
        ...
        <div class="custom-form-cntr ecourt-services-form">
                <form action="#" method="post" role="search" aria-label="Search your case" id="ecourt-services-case-status-party-name" novalidate="novalidate">
...
<div class="form-row">
    <div class="first_col">
        <label for="litigant_name">Petitioner/Respondent <span class="redStar"> * </span></label>
    </div>
    <div class="second_col">
        <input type="text" name="litigant_name" id="litigant_name" autocomplete="off">
    </div>
