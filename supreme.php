...
<head>
    ...
    <title>CCTS - Supreme Court</title>
            ...
            <div class="row bg-light px-3 py-4">
                <div class="col-md-3">
                    ...
                    <select class="form-select form-select-sm" id="court">
                        <option value="">WP under Article 32</option>
                        <option value="">Civil Appeal before Supreme Court</option>
                        <option value="">Special Leave Petition</option>
                        <option value="">Transfer Petitions</option>
